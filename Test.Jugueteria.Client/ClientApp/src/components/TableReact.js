                    ...
                    <div id="DataTables_Table_0_filter" className="dataTables_filter">
                        <div className="form-group">
                            <div className="input-group">
                                <span className="input-group-addon"><i className="fas fa-search" /></span>
                                <input type="text" className="form-control" placeholder={placeHolderText ? placeHolderText : "Escriba aquí para buscar ..."} value={search || ""} onChange={async (e) => {
                                    pageExtends = 1;
