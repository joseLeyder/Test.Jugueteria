(function ($) {
  ...
  Selectpicker.prototype = {
    ...
    createDropdown: function () {
      ...
      var header = this.options.header ? '<div class="popover-title"><button type="button" class="close" aria-hidden="true"><i className="fas fa-times"></i></button>' + this.options.header + '</div>' : '';
